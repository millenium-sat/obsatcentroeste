...
const LaunchCountdown = ({ days, hours, minutes, seconds }) => {
    ...
    return (
        <>
            <Countdown prev={0} count={remainTime.days} label={'Dias'} />
            <Countdown prev={0} count={remainTime.hours} label={'Horas'} />
            <Countdown prev={0} count={remainTime.minutes} label={'Minutos'} />
            <Countdown prev={0} count={remainTime.seconds} label={'Segundos'} />
        </>
    );
};
